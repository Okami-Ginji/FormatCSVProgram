...
public class FormatCSVDAO {
    private static FormatCSVDAO instance = null;
    ...
    public static FormatCSVDAO Instance() {
        if (instance == null) {
            synchronized (FormatCSVDAO.class) {
                if (instance == null) {
                    instance = new FormatCSVDAO();
                }
            }
        }
        return instance;
